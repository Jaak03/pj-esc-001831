# TradeSafe Service #
## GraphQL ##
I have had a look around and for now I am planning on using the [rebing/graphql-laravel](https://github.com/rebing/graphql-laravel) package. This was suggested in [this](https://www.freecodecamp.org/news/build-a-graphql-api-using-laravel/) guide from freecodecamp.org, and it seems to be the most active package 
